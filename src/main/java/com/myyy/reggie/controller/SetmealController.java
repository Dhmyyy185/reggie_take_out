...
import com.myyy.reggie.dto.SetmealDto;
...
import com.myyy.reggie.service.SetmealDishService;
import com.myyy.reggie.service.SetmealService;
...
public class SetmealController {
    ...
    public R<String> updateStatus(@PathVariable Integer status, @RequestParam List<Long> ids) {
        ...
        log.info("更改套餐状态: {}", ids.toString());

        LambdaUpdateWrapper<Setmeal> queryWrapper = new LambdaUpdateWrapper<>();
        queryWrapper.in(Setmeal::getId, ids);
        queryWrapper.set(ids.size() != 0, Setmeal::getStatus, status);
